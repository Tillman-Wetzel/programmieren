...
execute if items entity @s weapon.mainhand fishing_rod[custom_data={stabshot:1b}] run playsound item.shield.break player @a[distance=..10] ~ ~ ~ 30 1
execute if items entity @s weapon.mainhand fishing_rod[custom_data={nukeshot:1b}] run playsound item.shield.break player @a[distance=..10] ~ ~ ~ 30 1
