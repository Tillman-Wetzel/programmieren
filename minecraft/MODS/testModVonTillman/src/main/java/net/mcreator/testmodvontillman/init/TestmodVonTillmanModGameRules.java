...
public class TestmodVonTillmanModGameRules {
	public static final DeferredRegister<GameRule<?>> REGISTRY = DeferredRegister.create(Registries.GAME_RULE, TestmodVonTillmanMod.MODID);
