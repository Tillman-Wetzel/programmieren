package net.mcreator.testmodvontillman;
...
import net.mcreator.testmodvontillman.init.*;
...
@Mod("testmod_von_tillman")
public class TestmodVonTillmanMod {
	public static final Logger LOGGER = LogManager.getLogger(TestmodVonTillmanMod.class);
	public static final String MODID = "testmod_von_tillman";

	public TestmodVonTillmanMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		TestmodVonTillmanModBlocks.REGISTRY.register(modEventBus);
		TestmodVonTillmanModBlockEntities.REGISTRY.register(modEventBus);
		TestmodVonTillmanModItems.REGISTRY.register(modEventBus);
		TestmodVonTillmanModTabs.REGISTRY.register(modEventBus);
		TestmodVonTillmanModVillagerProfessions.PROFESSIONS.register(modEventBus);
