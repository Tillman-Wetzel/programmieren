package net.mcreator.tillmanstollemod;
...
import net.mcreator.tillmanstollemod.init.TillmanstollemodModTabs;
...
@Mod("tillmanstollemod")
public class TillmanstollemodMod {
	public static final Logger LOGGER = LogManager.getLogger(TillmanstollemodMod.class);
	public static final String MODID = "tillmanstollemod";

	public TillmanstollemodMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		TillmanstollemodModItems.REGISTRY.register(modEventBus);
		TillmanstollemodModTabs.REGISTRY.register(modEventBus);
		TillmanstollemodModGameRules.REGISTRY.register(modEventBus);
		TillmanstollemodModAttributes.REGISTRY.register(modEventBus);
