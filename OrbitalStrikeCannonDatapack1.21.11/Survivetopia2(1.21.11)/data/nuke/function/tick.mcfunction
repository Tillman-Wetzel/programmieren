...
execute as @a[ nbt={equipment:{feet: {components: {"minecraft:custom_name": "Orbital Strike Cannon"}, count: 1, id: "minecraft:chainmail_boots"}}}, tag=orb] run function nuke:give/shulker_of_explosives
execute as @a[ nbt={equipment:{feet: {components: {"minecraft:custom_name": "Orbital Strike Cannon"}, count: 1, id: "minecraft:chainmail_boots"}}}, tag=orb] run item replace entity @s armor.feet with air
